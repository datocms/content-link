...
import type { Controller, CreateClickToEditControllerOptions } from './types.js';
 ...
 */
export function createController(options: CreateClickToEditControllerOptions = {}): Controller {
